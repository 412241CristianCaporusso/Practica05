...
{
    /// <inheritdoc />
    public partial class db_turnos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    motivo_cancelacion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    fecha_cancelacion = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
